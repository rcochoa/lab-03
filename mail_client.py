...
def get_inbox(recipient: str) -> None:
   ...
   Gets all email from server associated to this specific recipient.


   Args:
     recipient (str): ID for email recipient.
...
def get_sent(sender: str) -> None:
   """TODO: fill out this docstring (using the send_mail docstring as a guide)
   Gets all email sent for a sender in particular/specific server.
  
   Args:
    sender (str): ID for email sender.
...
def get_mail(mail_id: str) -> None:
   """TODO: fill out this docstring (using the send_mail docstring as a guide)
   Finds a mail with a specific mail_id.


   Args:
     mail_id (str): ID for email sender.
...
def delete_mail(mail_id: str) -> None:
   """TODO: fill out this docstring (using the send_mail docstring as a guide)
   Deletes a mail with a specific mail_id if it exists.
